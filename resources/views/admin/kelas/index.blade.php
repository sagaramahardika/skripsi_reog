...
@section('content')
    <div class="container" id="kelas-index">
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body" id="kelas-data" style="visibility:hidden">
                        ...
                        <table id="kelas" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            <thead>
